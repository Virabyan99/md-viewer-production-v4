...
export function FullscreenCodeModal() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={closeModal}>
      <DialogContent
        className="max-w-4xl w-[90vw] max-h-[90vh] p-6 bg-background border border-border rounded-lg shadow-lg"
        maxWidth="4xl">
        <DialogTitle />
        <animated.div style={style}>
          ...
          <div className="relative max-w-[800px] fullscreen-code-block rounded-md p-4 overflow-x-auto max-h-[70vh]">
